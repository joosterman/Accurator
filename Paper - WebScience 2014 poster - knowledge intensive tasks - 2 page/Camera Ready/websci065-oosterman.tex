...
\subtitle{\aufnt{Jasper~Oosterman\wu, Archana~Nottamkandath\wg, Chris~Dijkshoorn\wg\\Alessandro~Bozzon\wu, Geert-Jan~Houben\wu, Lora~Aroyo\wg}}
%
...
\alignauthor 
       ...
       \affaddr{Mekelweg 4, 2628 CD} \\
       \affaddr{Delft, The Netherlands} \\
       \affaddr{\{j.e.g.oosterman,a.bozzon,\\g.j.p.m.houben\}@tudelft.nl}
\and
% 2nd. author
\alignauthor 
       \affaddr{{\wg}VU University Amsterdam} \\
       \affaddr{De Boelelaan 1081a, 1081 HV } \\
       \affaddr{Amsterdam, The Netherlands} \\
       \affaddr{\{a.nottamkandath,c.r.dijkshoorn,\\lora.aroyo\}@vu.nl} 
}
