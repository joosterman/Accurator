...
Since external users are not familiar with the professional classification schemes and expert knowledge the institutions target, a fourth main challenge is in breaking down the annotation process must be broken down into facile tasks that can be solved with little effort and without this kind of professional knowledge. %(suggested in \cite{He2013}).
